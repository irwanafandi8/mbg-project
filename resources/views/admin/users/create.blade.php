<x-layouts.admin title="Tambah Administrator Sekolah">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="font-semibold text-slate-800">Form Administrator Sekolah</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-2 pt-4 border-t border-slate-100">
                        ...
                        <button type="submit" class="btn-primary">Simpan Administrator Sekolah</button>
                    </div>
                </form>
            </div>
        </div>
