<x-layouts.admin title="Kirim Saran" breadcrumb="Sampaikan saran atau masukan untuk meningkatkan layanan MBG">

    <div>
        <div class="flex items-center gap-3 mb-6">
            <a href="{{ admin_route('suggestions.index') }}" class="btn-outline btn-sm">
            ...
            <div class="card-body">
                <div class="alert-info mb-6">
                    ...
                    <p class="text-sm">Saran bersifat teks dan akan dibaca oleh administrator. Untuk keluhan yang
                        memerlukan tindakan, gunakan fitur <a href="{{ admin_route('complaints.create') }}"
                            class="text-blue-700 font-medium hover:underline">Buat Aduan</a>.</p>
                </div>

                <form method="POST" action="{{ admin_route('suggestions.store') }}">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ admin_route('suggestions.index') }}" class="btn-outline px-6">Batal</a>
                    </div>
                </form>
            </div>
        </div>
