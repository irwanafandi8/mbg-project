<x-layouts.user title="Buat Aduan Baru">
    ...
    <div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('user.complaints.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <select name="priority" class="form-select {{ $errors->has('priority') ? 'error' : '' }}">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('user.complaints.index') }}" class="btn-outline px-6 py-3">Batal</a>
                    </div>
                </form>
            </div>
        </div>
